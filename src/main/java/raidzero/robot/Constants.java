...
public class Constants {
  ...
  public static final class SwerveConstants {
    ...
    public static final double THROTTLE_REDUCTION =
    ...
    public static final double THROTTLE_KF =
      1023 /
      (
        MAX_VEL_MPS /
  ...
  public static final class DriveConstants {
    ...
    private static final double MAX_ACCEL_DISTANCE =
      6.0 * Math.pow(TIMEOUT_S, 2);
    private static final double GYRO_ERROR_DEGREES_TIMEOUT =
      (0.4 / SECONDS_IN_MINUTE) * TIMEOUT_S;
  ...
  public static final class ArmConstants {
    ...
    public static final SparkMaxLimitSwitch.Type LOWER_FORWARD_LIMIT_TYPE =
      SparkMaxLimitSwitch.Type.kNormallyOpen;
    public static final SparkMaxLimitSwitch.Type LOWER_REVERSE_LIMIT_TYPE =
      SparkMaxLimitSwitch.Type.kNormallyOpen;
  ...
  public static final PneumaticsModuleType PNEUMATICS_MODULE_TYPE =
