...
// // mps
// Vector2D driveTrainVelocity = new Vector2D((currentPose.getX() -
// prevPose.getX()) * 50,
...
// // Estimate
// Translation2d estimatedGoalPoseAtTOF = new
// Translation2d(driveTrainVelocity.getX() * tof * -1,
// driveTrainVelocity.getY() * tof * -1);

// // Calculate angle & dist
// double distToGoal = Math.hypot(currentPose.getX() -
// estimatedGoalPoseAtTOF.getX(),
// currentPose.getY() - estimatedGoalPoseAtTOF.getY());
// Rotation2d angleToGoal = new Rotation2d(Math.atan2(currentPose.getX() -
// estimatedGoalPoseAtTOF.getX(),
// currentPose.getY() - estimatedGoalPoseAtTOF.getY()));
// }
