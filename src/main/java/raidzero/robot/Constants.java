...
public class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final Matrix<N1, N1> ANGLE_STDEVS_MATRIX = new MatBuilder<N1, N1>(Nat.N1(), Nat.N1())
                .fill(GYRO_ERROR_DEGREES_TIMEOUT);
        public static final Matrix<N3, N1> VISION_STDEVS_MATRIX = new MatBuilder<N3, N1>(Nat.N3(), Nat.N1()).fill(1.0,
                1.0, 1.0);
    }
