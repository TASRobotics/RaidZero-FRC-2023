...
import raidzero.robot.auto.actions.AutoBalance;
...
public class SingleConeBalanceSequence extends AutoSequence {
    ...
    public SingleConeBalanceSequence() {
    ...
    public String getName() {
        return "Single Cone Balance Sequence";
    }
}
