...
public class DoubleJointedArm {
        ...
        public Matrix<N2, N1> feedForward(double[] states, double[][] accels) {
                ...
                Matrix<N2, N2> M = new MatBuilder<N2, N2>(Nat.N2(), Nat.N2()).fill(dM[0][0][0], dM[0][0][0],
                                dM[0][1][0],
                                dM[0][1][1]);
                Matrix<N2, N2> C = new MatBuilder<N2, N2>(Nat.N2(), Nat.N2()).fill(dM[1][0][0], dM[1][0][1],
                                dM[1][1][0],
                                dM[1][1][1]);
                ...
                Matrix<N2, N2> B_inv = new MatBuilder<N2, N2>(Nat.N2(), Nat.N2()).fill(dM[3][0][0], dM[3][0][1],
                                dM[3][1][0],
                                dM[3][1][1]);
                Matrix<N2, N2> Kb = new MatBuilder<N2, N2>(Nat.N2(), Nat.N2()).fill(dM[4][0][0], dM[4][0][1],
                                dM[4][1][0],
                                dM[4][1][1]);
