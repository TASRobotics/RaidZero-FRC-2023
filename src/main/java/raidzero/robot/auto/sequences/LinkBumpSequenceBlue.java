...
public class LinkBumpSequenceBlue extends AutoSequence {
    ...
    private PathPlannerTrajectory mOut = PathPlanner.loadPath("CC Bump Pickup Blue",
            SwerveConstants.MAX_DRIVE_VEL_MPS * 0.8,
            SwerveConstants.MAX_DRIVE_ACCEL_MPSPS * 1.0);
    private PathPlannerTrajectory mReturn = PathPlanner.loadPath("CC Bump Score Blue",
